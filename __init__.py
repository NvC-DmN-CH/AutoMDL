                    ...
                    if context.scene.cdmaterials_type == '0': # if "Same as MDL" is selected
                        ...
                        for slot in context.scene.vis_mesh.material_slots:
                            ...
                            with open(vmt_path, "a") as file:
                                vmt_basetexture = os.path.join(root, "<REFERENCE VTF>")
                                file.write("// Placeholder VMT generated by AutoMDL")
                                file.write("VertexLitGeneric\n")
                                file.write("{")
                                file.write(f"\tbasetexture \"{vmt_basetexture}\"")
                                file.write("}")
                                pass
...
class AddonPrefs(bpy.types.AddonPreferences):
    ...
    def draw(self, context):
        ...
        row.prop(self, "do_make_vmts", text="Also make placeholder VMTs (Only applicable if using \"Same as MDL\")")
